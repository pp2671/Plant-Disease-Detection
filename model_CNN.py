...
path1 = 'F:/Softech Solution Code/Plant Disease Detection/archive/New Plant Diseases Dataset(Augmented)/New Plant Diseases Dataset(Augmented)/train/Corn_(maize)___Northern_Leaf_Blight'    #path of folder of images    
path2 = 'F:/Softech Solution Code/Plant Disease Detection/test_set/2'  #path of folder to save images    
