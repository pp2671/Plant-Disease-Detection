...
#
lbl = tk.Label(root, text="PLANT DISEASE DETECTION USING MACHINE LEARNING", font=('times', 35,' bold '), height=1, width=60,bg="maroon",fg="white")
lbl.place(x=0, y=3)
...
def openimage():
    ...
    global fn
    fileName = askopenfilename(initialdir='F:/Softech Solution Code/Plant Disease Detection/test_set', title='Select image for Aanalysis ',
                               filetypes=[("all files", "*.*")])
    IMAGE_SIZE=200
    imgpath = fileName
    fn = fileName
